<?php
//$dsn = 'mysql://user:pass@localhost/moodle/';
$dsn = 'pgsql://teste:teste@127.0.0.1:5432/testes/';
...
if (in_array($http = strtoupper($_SERVER['REQUEST_METHOD']), array('POST', 'PUT')) === true)
{
	...
	{
		if ((strcasecmp($_SERVER['CONTENT_TYPE'], 'application/json') === 0) || (strcasecmp($_SERVER['CONTENT_TYPE'], 'application/json;charset=UTF-8') === 0))
		{
